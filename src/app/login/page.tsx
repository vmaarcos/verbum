          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="block w-full px-3 py-2 mt-1 placeholder-gray-500 border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
